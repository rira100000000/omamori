...
module Omamori
  class Config
    ...
    def validate_api_key
      ...
      return unless api_key && !api_key.is_a?(String)
    ...
    def validate_model
      model = @config['model']
      return unless model && !model.is_a?(String)
    ...
    def validate_checks
      ...
      return unless checks && !checks.is_a?(Array)
    ...
    def validate_prompt_templates
      ...
      return unless prompt_templates && !prompt_templates.is_a?(Hash)
    ...
    def validate_report_settings
      ...
      return unless report.key?('html_template') && !report['html_template'].is_a?(String)
    ...
    def validate_static_analyser_settings
      ...
      return unless static_analysers
      ...
      return unless static_analysers.key?('bundler_audit')

      bundler_audit_config = static_analysers['bundler_audit']
      if bundler_audit_config.is_a?(Hash)
    ...
    def validate_ci_setup_settings
      ...
      return unless ci_setup.key?('gitlab_ci_path') && !ci_setup['gitlab_ci_path'].is_a?(String)
    ...
    def validate_language
      ...
      return unless language && !language.is_a?(String)
